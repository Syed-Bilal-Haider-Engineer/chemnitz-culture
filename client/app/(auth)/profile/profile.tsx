...
const SignupForm = () => {
  ...
  return (
    <>
   {isSignUp && <Modal>
    <div className=" inset-0 bg-opacity-50 flex items-center justify-center p-4 width-full">
      <div className="relative bg-white rounded-xl shadow-xl  w-[50%] p-6">
